...
class AboutFragment : BaseFragment(R.layout.fragment_about) {
    ...
    private lateinit var translatorsLabel: TextView
    private lateinit var translatorsView: TextView
    ...
    override fun onCreateView(
        ...
        if (Strings.isEmpty(translatorsView.text)) {
            translatorsLabel.visibility = View.GONE
            translatorsView.visibility = View.GONE
        }
