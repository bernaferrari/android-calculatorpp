...
open class Standard(val flags: Int) {
    ...
    open fun makePairsGM(polynomial: Polynomial) {
        ...
        val map = SortedMutableMap<Pair, Any?>(
    ...
    open fun reduce() {
        ...
        val map = SortedMutableMap.naturalOrder<Polynomial, Any?>()
        val size = polys.size
