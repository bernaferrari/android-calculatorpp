 ...
 * @since 2.1
 */
class MutableInt(private var value: Int = 0) : Number(), Comparable<MutableInt> {
     ...
     * @throws NullPointerException if the object is null
     * @throws ClassCastException   if the type is not a [Number]
     */
    fun setValue(value: Any) {
        setValue((value as Number).toInt())
    }
     ...
     *
     * @param other the mutable to compare to
     * @return negative if this is less, zero if equal, positive if greater
     */
    override fun compareTo(other: MutableInt): Int {
        val anotherVal = other.value
        return when {
            value < anotherVal -> -1
            value == anotherVal -> 0
            else -> 1
    ...
    companion object {
         ...
         */
        private const val serialVersionUID = 512176391864L
    }
}
