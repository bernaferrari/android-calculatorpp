...
open class ParseException : Exception, Message {
    ...
    override fun getLocalizedMessage(locale: JsclLocale): String {
        val messagePattern = JsclMessageBundle.getString(getMessageCode(), locale)
        return AbstractMessage.makeMessage(locale, messagePattern, parameters, MessageType.error)
    }
