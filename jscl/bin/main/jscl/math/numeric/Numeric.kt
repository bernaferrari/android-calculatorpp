...
abstract class Numeric : Arithmetic<Numeric>, INumeric<Numeric>, Comparable<Numeric> {
    ...
    companion object {
        ...
        @JvmStatic
        protected fun defaultToRad(value: Double): Double {
            return JsclMathEngine.getInstance().angleUnits.transform(AngleUnit.rad, value)
        }

        @JvmStatic
        protected fun radToDefault(value: Double): Double {
            return AngleUnit.rad.transform(JsclMathEngine.getInstance().angleUnits, value)
        }

        @JvmStatic
        protected fun defaultToRad(value: Numeric): Numeric {
            return JsclMathEngine.getInstance().angleUnits.transform(AngleUnit.rad, value)
        }

        @JvmStatic
        protected fun radToDefault(value: Numeric): Numeric {
            return AngleUnit.rad.transform(JsclMathEngine.getInstance().angleUnits, value)
        }
    }
}
